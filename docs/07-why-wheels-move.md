...
You now have electricity — a controllable flow of energy you can switch on, vary in strength, and route anywhere. The question is what to do with it. The most direct answer: make things move. But moving a robot across a floor isn't as simple as applying power.
...
**Continue → [Why Things Refuse to Move](08-why-things-refuse-to-move.md)**
