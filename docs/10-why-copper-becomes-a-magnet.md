...
The clue is in what Ørsted observed in 1820: current in a wire deflects a compass needle. So current affects magnetic fields. Can current *create* one?
...
**Continue → [Why Electricity Can Push](11-why-electricity-can-push.md)**
