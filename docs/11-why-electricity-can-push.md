...
Current-carrying wires create magnetic fields (as we proved in the previous chapter). So maybe the wire becomes a temporary magnet and the external field attracts it — just like an iron nail.
...
**Continue → [Why Motors Spin](12-why-motors-spin.md)**
