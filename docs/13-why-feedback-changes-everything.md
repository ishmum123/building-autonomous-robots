...
- Not overcorrect (creating oscillation as in Chapter 11)
...
The cost: feedback can oscillate (Chapter 11). The gain K_p must be chosen carefully — high enough to respond quickly, low enough to avoid overshoot. But this is a tunable tradeoff, not a fundamental barrier.
