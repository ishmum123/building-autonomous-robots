...
- The motor has a coil spinning in a magnetic field. From Chapter 11, moving conductors in magnetic fields experience forces — but also generate voltages. Could the spinning coil *generate* a voltage that opposes the driving voltage?
...
The rotating coil inside the motor is a conductor moving in a magnetic field. From Chapter 11, moving conductors in magnetic fields experience forces. By symmetry, moving conductors also *generate* voltages — this is electromagnetic induction (the inverse of the Lorentz force).
...
**Continue → [Why Brushes Had to Disappear](14-why-brushes-had-to-disappear.md)**
