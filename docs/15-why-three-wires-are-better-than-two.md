...
You've decided to build a brushless motor (Chapter 14). The stator has coils; the rotor has permanent magnets. The controller energizes the coils to pull the rotor forward. But how many coils do you need, and how should they be arranged?
...
**Continue → [Why Faster Isn't Better](16-why-faster-isnt-better.md)**
