...
"Briefly" — because gyroscopes drift too (Chapter 26). But that's a separate problem.
...
**Continue → [Why Gyroscopes Drift](26-why-gyroscopes-drift.md)**
