...
This probabilistic approach — treating each sensor's reading as a sample from a probability distribution, and combining distributions optimally — is **sensor fusion**, the topic of Chapter 29. The disagreement between sensors is not a problem; it is data about the sensors' relative reliability.
...
**Continue → [Why Sensor Fusion Works](29-why-sensor-fusion-works.md)**
