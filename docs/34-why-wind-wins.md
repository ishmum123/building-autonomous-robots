...
The problem is the 100 ms GPS update delay. Speed up the position control loop. Use the IMU-derived velocity estimate (from GPS/IMU fusion, Chapter 29) instead of waiting for GPS updates. Run the position loop at 100 Hz instead of 10 Hz.
...
**Continue → [Why Autopilots Exist](35-why-autopilots-exist.md)**
