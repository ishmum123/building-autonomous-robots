...
The architecture that emerges from this insight is hierarchical, exactly like the quadcopter's two-loop architecture (Chapter 23), but with more levels:
...
**Continue → [Why Drones Crash](36-why-drones-crash.md)**
