...
Localization (chapter 39) requires a map to tell you where you are. Map building (chapter 37) requires knowing where you are to mark sensor readings in the right place. You have neither. You can't build a map without knowing your position. You can't find your position without a map.
...
**Continue → [Why Planning Is Hard](41-why-planning-is-hard.md)**
