...
Reads mkdocs.yml nav, emits:
  - Part heading files (part-I.md … part-VI.md) in <outdir>
...
# Matches the <iframe> line (possibly with trailing content on same line)
...
def chapter_num_from_filename(fname):
    """e.g. '01-why-wheels-move.md' -> 'chapter01'"""
...
spine = []  # list of paths relative to OUTDIR (or absolute)
current_part = None
